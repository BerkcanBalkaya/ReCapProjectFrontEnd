...
const routes: Routes = [
  ...
  {path:"cars/brand/:brandId",component:CarsPageComponent},
  {path:"cars/color/:colorId",component:CarsPageComponent},
  {path:"cars/color/:colorId:brandId",component:CarsPageComponent},
